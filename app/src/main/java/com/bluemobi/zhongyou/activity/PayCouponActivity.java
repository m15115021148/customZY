...
public class PayCouponActivity extends BaseActivity implements PaymentMethodAdapter.OnPaymentMethodCallBack{
    ...
    public SparseArray getData(){
        ...
        if (mOrderBean!=null){
            ...
            mOrderBean.setStatus(getResources().getString(R.string.pay_coupon_used));
    ...
    public void onItemPaymentListener(int position) {
        ...
        switch (position){
            ...
            case 4:
                ...
                card.putExtra("model",(OrderBean)mAdapter.getData().get(0));
                card.putExtra("CouponBean",(CouponBean)mAdapter.getData().get(1));

...
import com.bluemobi.zhongyou.view.scan.QRCoverView;
import com.bluemobi.zhongyou.view.scan.SoundUtils;
...
public class CaptureActivity extends BaseActivity implements SurfaceHolder.Callback {
    ...
    public QRCoverView mFinderView;
    ...
    Camera.PreviewCallback previewCallback = new Camera.PreviewCallback() {
        public void onPreviewFrame(byte[] data, Camera camera) {
            if (asyncDecode.isStoped()) {
                ...
                RectF scanImageRect = mFinderView.getViewFinderRect();
                //图片旋转了90度，将扫描框的TOP作为left裁剪
                source.setCrop((int)scanImageRect.top, (int)scanImageRect.left, (int)scanImageRect.height(), (int)scanImageRect.width());
    ...
    private class AsyncDecode extends AsyncTask<Image, Void, Void> {
        ...
        protected Void doInBackground(Image... params) {
            ...
            if (nsyms != 0) {
                ...
                decode_count++;
                sb.append("count: " + String.valueOf(decode_count) + ", time consuming: " + String.valueOf(cost_time) + " ms \n");
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        try {
            ...
            LogUtil.d("DBG", "surfaceCreated: " + e.getMessage());
            mCamera = null;
        }
    }
    ...
    private void initBeepSound() {
        if (soundUtils == null) {
            soundUtils = new SoundUtils(this, SoundUtils.SINGLE_PLAY);
